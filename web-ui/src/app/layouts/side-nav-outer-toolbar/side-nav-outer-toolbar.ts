...
import { SideNavigationMenu, Header } from '../../shared/components';
import { ScreenService, ThemeService } from '../../shared/services';

@Component({
  selector: 'app-side-nav-outer-toolbar',
  templateUrl: './side-nav-outer-toolbar.html',
  styleUrls: ['./side-nav-outer-toolbar.scss'],
  standalone: true,
  imports: [ CommonModule, SideNavigationMenu, DxDrawerModule, Header, DxScrollViewModule ],
})
export class SideNavOuterToolbar implements OnInit {
