...
public class FyersOrderPlacement {
    ...
    public OrderResult placeOrder(PlaceOrderModel model) {
        Tuple<JSONObject, JSONObject> tuple = FyersClientFactory.getConfiguredInstance().PlaceOrder(model);
        if (tuple.Item2() != null) {
    ...
    public MultiOrderResult placeMultipleOrders(List<PlaceOrderModel> models) {
        Tuple<JSONObject, JSONObject> tuple = FyersClientFactory.getConfiguredInstance().PlaceMultipleOrders(models);
        if (tuple.Item2() != null) {
    ...
    public MultiOrderResult placeMultiLegOrder(List<MultiLegModel> models) {
        Tuple<JSONObject, JSONObject> tuple = FyersClientFactory.getConfiguredInstance().PlaceMultiLegOrder(models);
        if (tuple.Item2() != null) {
