...
public class OptionChainResult {
    ...
    public static class VixData {
        ...
        private VixData(String symbol, String fyToken, String exchange, String description,
            ...
            this.symbol = symbol; this.fyToken = fyToken; this.exchange = exchange;
            this.description = description; this.ltp = ltp; this.ltpCh = ltpCh; this.ltpChp = ltpChp;
        }
    ...
    public static class OptionEntry {
        ...
        private OptionEntry(String symbol, String fyToken, String exchange, String description,
            ...
            this.symbol = symbol; this.fyToken = fyToken; this.exchange = exchange;
            this.description = description; this.optionType = optionType;
            this.ltp = ltp; this.ltpCh = ltpCh; this.ltpChp = ltpChp;
            this.fp = fp; this.fpCh = fpCh; this.fpChp = fpChp;
            this.bid = bid; this.ask = ask; this.strikePrice = strikePrice;
            this.oi = oi; this.oiCh = oiCh; this.oiChp = oiChp; this.volume = volume;
        }
    ...
    public static class Expiry {
        ...
        private Expiry(String date, long expiry) {
            this.date = date; this.expiry = expiry;
        }
