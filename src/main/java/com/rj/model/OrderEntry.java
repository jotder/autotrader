...
public class OrderEntry {
    ...
    public static final class Builder {
        ...
        public Builder idFyers(String v) {
            idFyers = v;
            return this;
        }
        ...
        public Builder exchOrdId(String v) {
            exchOrdId = v;
            return this;
        }

        public Builder orderNumStatus(String v) {
            orderNumStatus = v;
            return this;
        }
        ...
        public Builder orderValidity(String v) {
            orderValidity = v;
            return this;
        }
        ...
        public Builder slNo(int v) {
            slNo = v;
            return this;
        }

        public Builder instrument(int v) {
            instrument = v;
            return this;
        }
        ...
        public Builder qty(int v) {
            qty = v;
            return this;
        }

        public Builder filledQty(int v) {
            filledQty = v;
            return this;
        }
        ...
        public Builder disclosedQty(int v) {
            disclosedQty = v;
            return this;
        }

        public Builder offlineOrder(boolean v) {
            offlineOrder = v;
            return this;
        }

        public Builder lp(double v) {
            lp = v;
            return this;
        }

        public Builder limitPrice(double v) {
            limitPrice = v;
            return this;
        }

        public Builder tradedPrice(double v) {
            tradedPrice = v;
            return this;
        }

        public Builder stopPrice(double v) {
            stopPrice = v;
            return this;
        }

        public Builder ch(double v) {
            ch = v;
            return this;
        }

        public Builder chp(double v) {
            chp = v;
            return this;
        }

        public Builder takeProfit(double v) {
            takeProfit = v;
            return this;
        }

        public Builder stopLoss(double v) {
            stopLoss = v;
            return this;
        }
