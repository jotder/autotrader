...
public class TradeEntry {
    ...
    public static final class Builder {
        ...
        public Builder tradeNumber(String v)     { tradeNumber     = v; return this; }
        ...
        public Builder exchangeOrderNo(String v) { exchangeOrderNo = v; return this; }
        public Builder orderTag(String v)        { orderTag        = v; return this; }
        public Builder productType(String v)     { productType     = v; return this; }
        public Builder orderType(int v)          { orderType       = v; return this; }
        public Builder side(int v)               { side            = v; return this; }
        public Builder tradedQty(int v)          { tradedQty       = v; return this; }
        public Builder segment(int v)            { segment         = v; return this; }
        public Builder exchange(int v)           { exchange        = v; return this; }
        public Builder row(long v)               { row             = v; return this; }
        public Builder tradeValue(double v)      { tradeValue      = v; return this; }
        public Builder tradePrice(double v)      { tradePrice      = v; return this; }

        public TradeEntry build() { return new TradeEntry(this); }
    }
}