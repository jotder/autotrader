...
public class FundSummary {
    ...
    public static final class FundLimit {
        ...
        public double getCommodityAmount(){ return commodityAmount; }
    ...
    public List<FundLimit> getFundLimits() { return fundLimits; }
    ...
    /** id=1  Total Balance */
    public double getTotalBalance()          { return equity(1); }
    /** id=2  Utilized Amount */
    public double getUtilizedAmount()        { return equity(2); }
    /** id=3  Clear Balance */
    public double getClearBalance()          { return equity(3); }
    /** id=4  Realized P&L */
    public double getRealizedPnl()           { return equity(4); }
    /** id=5  Collaterals */
    public double getCollaterals()           { return equity(5); }
    /** id=6  Fund Transfer */
    public double getFundTransfer()          { return equity(6); }
    /** id=7  Receivables */
    public double getReceivables()           { return equity(7); }
    /** id=8  Adhoc Limit */
    public double getAdhocLimit()            { return equity(8); }
    /** id=9  Limit at start of the day */
    public double getLimitAtStartOfDay()     { return equity(9); }
    /** id=10 Available Balance */
    public double getAvailableBalance()      { return equity(10); }
