...
public class Tick {
    ...
    public Instant getFeedTime()       { return feedTime; }
    ...
    public double getAvgTradePrice()   { return avgTradePrice; }
    public double getBidPrice()        { return bidPrice; }
    public double getAskPrice()        { return askPrice; }
    public double getChange()          { return change; }
    public double getChangePct()       { return changePct; }
    public long getVolTradedToday()    { return volTradedToday; }
    public long getLastTradedQty()     { return lastTradedQty; }
    public long getTotBuyQty()         { return totBuyQty; }
    public long getTotSellQty()        { return totSellQty; }
    ...
    public long getYearHigh()          { return yearHigh; }
    public long getYearLow()           { return yearLow; }
    ...
    public static final class Builder {
        ...
        public Builder feedTime(Instant v)       { feedTime = v;        return this; }
        public Builder lastTradedTime(Instant v) { lastTradedTime = v;  return this; }
        public Builder ltp(double v)             { ltp = v;             return this; }
        public Builder open(double v)            { open = v;            return this; }
        public Builder high(double v)            { high = v;            return this; }
        public Builder low(double v)             { low = v;             return this; }
        public Builder prevClose(double v)       { prevClose = v;       return this; }
        public Builder avgTradePrice(double v)   { avgTradePrice = v;   return this; }
        public Builder bidPrice(double v)        { bidPrice = v;        return this; }
        public Builder askPrice(double v)        { askPrice = v;        return this; }
        public Builder change(double v)          { change = v;          return this; }
        public Builder changePct(double v)       { changePct = v;       return this; }
        public Builder volTradedToday(long v)    { volTradedToday = v;  return this; }
        public Builder lastTradedQty(long v)     { lastTradedQty = v;   return this; }
        public Builder totBuyQty(long v)         { totBuyQty = v;       return this; }
        public Builder totSellQty(long v)        { totSellQty = v;      return this; }
        public Builder openInterest(long v)      { openInterest = v;    return this; }
        public Builder turnover(long v)          { turnover = v;        return this; }
        public Builder bidSize(int v)            { bidSize = v;         return this; }
        public Builder askSize(int v)            { askSize = v;         return this; }
        public Builder upperCircuit(long v)      { upperCircuit = v;    return this; }
        public Builder lowerCircuit(long v)      { lowerCircuit = v;    return this; }
        public Builder yearHigh(long v)          { yearHigh = v;        return this; }
        public Builder yearLow(long v)           { yearLow = v;         return this; }

        public Tick build() { return new Tick(this); }
    }
}
