...
public final class TradeSignal {
    ...
    public static final class Builder {
        ...
        public Builder direction(Signal v)         { direction = v;         return this; }
        public Builder confidence(double v)        { confidence = v;        return this; }
        public Builder suggestedEntry(double v)    { suggestedEntry = v;    return this; }
        public Builder suggestedStopLoss(double v) { suggestedStopLoss = v; return this; }
        public Builder suggestedTarget(double v)   { suggestedTarget = v;   return this; }
        public Builder strategyId(String v)        { strategyId = v;        return this; }
        public Builder vote(Timeframe tf, Signal s){ timeframeVotes.put(tf, s); return this; }
        public Builder generatedAt(Instant v)      { generatedAt = v;       return this; }

        public TradeSignal build() { return new TradeSignal(this); }
    }
}
