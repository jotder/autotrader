...
public final class CandleRecommendation {
    ...
    public double    getAtr14()          { return atr14;          }
    public double    getRelVolume()      { return relVolume;      }
    ...
    public static final class Builder {
        ...
        public Builder timeframe(Timeframe v)   { timeframe = v;      return this; }
        public Builder windowStart(Instant v)   { windowStart = v;    return this; }
        public Builder windowEnd(Instant v)     { windowEnd = v;      return this; }
        public Builder signal(Signal v)         { signal = v;         return this; }
        public Builder confidence(double v)     { confidence = v;     return this; }
        public Builder strategySource(String v) { strategySource = v; return this; }
        public Builder ema20(double v)          { ema20 = v;          return this; }
        public Builder ema50(double v)          { ema50 = v;          return this; }
        public Builder rsi14(double v)          { rsi14 = v;          return this; }
        public Builder atr14(double v)          { atr14 = v;          return this; }
        public Builder relVolume(double v)      { relVolume = v;      return this; }
        public Builder candle(Candle v)         { candle = v;         return this; }
        public Builder generatedAt(Instant v)   { generatedAt = v;    return this; }

        public CandleRecommendation build() { return new CandleRecommendation(this); }
    }
}